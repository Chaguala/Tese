...
set AGENT_STRING=-javaagent:"%GRAILS_HOME:\=/%/lib/org.springsource.springloaded/springloaded-core/jars/springloaded-core-1.1.3.jar" -noverify -Dspringloaded=\"%SPRINGLOADED_PARAMS%\"
...
set STARTER_CLASSPATH=%GRAILS_HOME%\lib\org.codehaus.groovy\groovy-all\jars\groovy-all-2.0.8.jar;%GRAILS_HOME%\dist\grails-bootstrap-2.2.4.jar
