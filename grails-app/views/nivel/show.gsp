...
<html>
    <head>
        ...
        <title><g:message code="nivel.show" default="Show Nivel" /></title>
    </head>
    <body>
        <div class="nav">
            ...
            <span class="menuButton"><g:link class="create" action="create"><g:message code="nivel.new" default="Criar" /></g:link></span>
        </div>
    <fieldset>
        <legend title=""/>
    </fieldset>
        ...
        <div class="body">
            <h4><g:message code="nivel.show" default="Detalhes" /></h4>
            <fieldset>
                <legend title=""/>
            </fieldset>
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name"><g:message code="nivel.id" default="Id" />:</td>
                                
                                <td valign="top" class="value">${fieldValue(bean: nivelInstance, field: "id")}</td>
                                
                            </tr>
                            
                            <tr class="prop">
                                <td valign="top" class="name"><g:message code="nivel.nivel" default="Nivel" />:</td>
                                
                                <td valign="top" class="value">${fieldValue(bean: nivelInstance, field: "nivel")}</td>
