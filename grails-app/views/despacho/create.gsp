...
<%@ page imporTt="org.chaguala.sigem.despacho.Despacho" %>
<!DOCTYPE html>
<html>
<head>
...
<richui:tabView id="tabView"><richui:tabLabels><richui:tabLabel selected="true"
                                                                title="${message(code: 'Criar Novo Despacho', args: [entityName])}"/></richui:tabLabels><richui:tabContents><richui:tabContent>
    <div class="nav">
