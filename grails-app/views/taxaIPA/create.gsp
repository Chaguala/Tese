...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'taxaipa.label', default: 'TaxaIPA')}"/>
...
<richui:tabView id="tabView"><richui:tabLabels><richui:tabLabel selected="true"
    ...
    <div class="nav">
        <nav:render group="TaxaIPA"/>
    </div>

    <div id="create-taxaipa" class="content scaffold-create" role="main">
        <h1 align="center"><g:message code="default.create.label" args="[entityName]"/></h1>
        <g:if test="${flash.message}">
            <div class="message" role="status">${flash.message}</div>
        </g:if>
        <g:hasErrors bean="${taxaipaInstance}">
            <ul class="errors" role="alert">
                <g:eachError bean="${taxaipaInstance}" var="error">
