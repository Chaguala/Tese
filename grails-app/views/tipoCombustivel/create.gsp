...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'tipocombustivel.label', default: 'TipoCombustivel')}"/>
...
<richui:tabView id="tabView"><richui:tabLabels><richui:tabLabel selected="true"
    ...
    <div id="create-tipocombustivel" class="content scaffold-create" role="main">
        <h1 align="center"><g:message code="default.create.label" args="[entityName]"/></h1>
        <g:if test="${flash.message}">
            <div class="message" role="status">${flash.message}</div>
        </g:if>
        <g:hasErrors bean="${tipocombustivelInstance}">
            <ul class="errors" role="alert">
                <g:eachError bean="${tipocombustivelInstance}" var="error">
