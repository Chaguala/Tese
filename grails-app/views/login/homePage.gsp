                            ...
                            %{--<li><a href="#">Requerente</a>--}%
                                <ul class="nav nav-pills nav-stacked main-menu">
                                    ...
                                    %{--<li><a href="#">Outros pedidos</a>--}%
                                        %{--<ul class="nav nav-pills navPes-stacked main-menu">--}%
                                            %{--<li>--}%
                            ...
                            <div class="col-lg-5 col-md-12 hidden-xs center-text">
                                ...
                                <row>
                                    <div id="logo" align="left">
                                        <img src="${resource(dir: 'images', file: 'googleMaps.jpg')}" style="margin-top: 40px;margin-left: 300px" height="400" width="720px"
                                             border="0" alt="" title="Google maps" />
                                    </div>
                                </row>
                                <row>
                                    <div id="map"></div>
