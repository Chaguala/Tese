...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'municipe.label', default: 'Municipe')}"/>
...
<richui:tabView id="tabView"><richui:tabLabels><richui:tabLabel selected="true"
    ...
    <div id="create-municipe" class="content scaffold-create" role="main">
        <h1 align="center"><g:message code="default.create.label" args="[entityName]"/></h1>
        <g:if test="${flash.message}">
            <div class="message" role="status">${flash.message}</div>
        </g:if>
        <g:hasErrors bean="${municipeInstance}">
            <ul class="errors" role="alert">
                <g:eachError bean="${municipeInstance}" var="error">
