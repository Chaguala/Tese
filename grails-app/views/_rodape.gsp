<footer class="row">
    <p class="col-md-9 col-sm-9 col-xs-12 copyright">&copy; <a href="#" target="_blank">Felizardo Chaguala</a> 2017</p>
</footer>
        ...
        %{--<ul class="collapse navbar-collapse nav navbar-nav top-menu">--}%
            ...
            %{--<li>--}%
                %{--<form class="navbar-search pull-left">--}%
                    %{--<input placeholder="Pesquisar" class="search-query form-control col-md-10" name="query"--}%
                           %{--type="text">--}%
                %{--</form>--}%
            %{--</li>--}%
        %{--</ul>--}%
